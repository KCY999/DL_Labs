...
def train_unet(data_path="./dataset/oxford-iiit-pet", batch_size=15, epochs=5, lr=1e-5, aug_type="combine", n_aug=0):
    ...
    optimizer = optim.AdamW(unn_model.parameters(), lr=lr)
    ...
    torch.save(unn_model.state_dict(), f"./saved_models/unet_weights_{epochs}_{lr}_{aug_type}_{n_aug}.pth")
...
def train_resnet34_unet(data_path="./dataset/oxford-iiit-pet", batch_size=10, epochs=5, lr=1e-5, aug_type="combine", n_aug=0):
    ...
    optimizer = optim.AdamW(resnet34_unet.parameters(), lr=lr)
...
if __name__ == "__main__":
    ...
    # train_unet(epochs=50, batch_size=15, lr=1e-5, aug_type="combine", n_aug=1)
    # train_resnet34_unet(epochs=50, batch_size=15, aug_type="combine", lr=1e-5, n_aug=1)


    # train_unet(epochs=50, batch_size=15, lr=1e-5, aug_type="flip", n_aug=1)
    # train_resnet34_unet(epochs=50, batch_size=15, lr=1e-5, aug_type="flip", n_aug=1)


    training("unet", epochs=2, batch_size=15, lr=1e-5, aug_type="combine", n_aug=0)
    training("resnet34_unet", epochs=2, batch_size=15, aug_type="combine", lr=1e-5, n_aug=1)

    training("unet", epochs=2, batch_size=15, lr=1e-5, aug_type="flip", n_aug=0)
    training("resnet34_unet", epochs=2, batch_size=15, lr=1e-5, aug_type="flip", n_aug=1)
