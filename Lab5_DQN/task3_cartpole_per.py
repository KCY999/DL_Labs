...
class DQNAgent:
    ...
    def train(self):
        ...
        td_error = abs(target_q - q_values) + 1e-7
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-dir", type=str, default="./task3_cartpole_per")
    parser.add_argument("--wandb-run-name", type=str, default="task3_cartpole_per")
