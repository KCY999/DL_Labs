...
class DQNAgent:
    ...
    def train(self):
        ...
        td_errors = torch.abs(q_values.detach() - target_q.detach())
        # print(errors.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-dir", type=str, default="./pong_results_task3_test_PER")
    parser.add_argument("--wandb-run-name", type=str, default="Pong-test_PER")
