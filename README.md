...
- **結果**:  
  ...
  <img src="Figs\lab2_U-Net_acc.png" alt="U-Net acc" width="480" height="300"/> <img src="Figs\lab2_U-Net_loss.png" alt="U-Net loss" width="480" height="300"/>

  - **ResNet34+U-Net**：lr=1e-3、`combine`、`n_aug=1` → **Dice Score = 0.9478**。  

  <img src="Figs\lab2_Res-U-Net_acc.png" alt="Res-U-Net acc" width="480" height="300"/> <img src="Figs\lab2_Res-U-Net_loss.png" alt="Res-U-Net loss" width="480" height="300"/>
